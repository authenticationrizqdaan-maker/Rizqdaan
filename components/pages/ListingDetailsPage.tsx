...
const ListingDetailsPage: React.FC<ListingDetailsPageProps> = ({ listing, listings, user, onNavigate }) => {
    ...
    const relatedListings = useMemo(() => {
        return listings
            .filter(l => l.category === listing.category && l.id !== listing.id && l.status !== 'blocked')
    ...
    const handleReportSubmit = async () => {
        ...
        try {
            if (db) {
                ...
                alert("Thank you. The listing has been reported to administrators.");
          ...
          <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center bg-gradient-to-b from-black/70 to-transparent z-30">
              ...
              <div className="flex gap-2">
                <button 
                    ...
                    className="p-2.5 bg-white/20 backdrop-blur-lg rounded-full text-white shadow-xl active:scale-90 transition-all hover:bg-red-500/20"
      ...
      {isReportModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
              <div className="bg-white dark:bg-dark-surface p-6 rounded-2xl shadow-2xl max-w-md w-full border border-gray-100 dark:border-gray-700 animate-pop-in">
                  ...
                  <p className="text-sm text-gray-500 mb-6">Help us maintain a safe community. Why are you reporting this?</p>
                  ...
                  <div className="flex gap-3 mt-8">
                      <button 
                        ...
                        className="flex-1 py-3 bg-gray-100 dark:bg-gray-700 text-gray-500 font-bold rounded-xl active:scale-95 transition-all"
                      >
                          Cancel
                      </button>
                      <button 
                        ...
                        className="flex-1 py-3 bg-red-600 text-white font-bold rounded-xl shadow-lg active:scale-95 transition-all disabled:opacity-50"
                      >
